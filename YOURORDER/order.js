...
const renderProducts = () => {
    ...
    console.log('Adding products to the page: ', products); 
    ...
    listProductHTML.addEventListener('click', (event) => {
        ...
        console.log("Product ID:", productElement ? productElement.dataset.id : 'No data-id found');
    
       
        if (positionClick.classList.contains('addCart') && productElement) {
...
document.querySelector('.checkOut').addEventListener('click', () => {
    ...
    window.location.href = 'paymentmet.html'; 
});
